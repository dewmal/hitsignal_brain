...
async def fx_candle_stream_prediction_(candles):
    ...
    predict(df=df, window_size=meth_settings.window_size, consider_value=meth_settings.consider_value,
            prediction_step=meth_settings.prediction_step, algo_max_window_size=meth_settings.algo_max_window_size)
